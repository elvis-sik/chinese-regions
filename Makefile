...
DOCKER_IMAGE ?= chinese-regions-anki-workbench
...
help:
	...
	@printf "  make apkg   Fetch media and build the Anki package\n"
...
apkg:
	$(UV) run --extra deck python scripts/fetch_region_media.py
