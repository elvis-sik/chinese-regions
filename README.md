...
The first seeded deck rows live in [`data/raw/china_regions_notes_seed.csv`](data/raw/china_regions_notes_seed.csv).
The field contract lives in [`CHINA_REGIONS_NOTE_TYPE.md`](CHINA_REGIONS_NOTE_TYPE.md).
